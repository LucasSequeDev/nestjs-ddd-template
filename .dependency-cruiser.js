  ...
  forbidden: [
    {
      name: "domain",
      severity: "error",
      comment: "[ CLEAN ARCHITECTURE ] Domain should not depend on anything",
      from: {
        path: "(^src/modules/.*/domain)",
      },
      to: {
        pathNot: ["^src/modules/.*/domain", "^src/modules/Shared/domain"],
      },
    },
    {
      name: "application",
      severity: "error",
      comment:
        "[ CLEAN ARCHITECTURE ] Application should depend application and domain only",
      from: {
